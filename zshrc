...
export ZSH=/home/qiuzq/.oh-my-zsh
...
VIRTUAL_HOME="$HOME/envs"

function _workon() {
    reply=( $(ls $VIRTUAL_HOME | cut -d: -f1) )
}

function workon() {
    local place=$1
    source $VIRTUAL_HOME/$place/bin/activate
}   
compctl -K _workon workon
# }}
